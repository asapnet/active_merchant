# because ActiveMerchant is dependent on newer versions of ActiveSupport, this file must be required
# for use with older versions of Rails or if one does not have the newer version of the ActiveSupport 
# gem installed
