...
require File.join(File.dirname(__FILE__), 'lib', 'support', 'delegate_support') # see http://groups.google.com/group/activemerchant/browse_thread/thread/03a56c0e4e29d1a0
